...
import org.zeromq.ZStar.Entourage;
import org.zeromq.ZStar.Fortune;
import org.zeromq.ZStar.Star;

public class TestZStar
{
    private static final class BlackHole implements Fortune
    {
        @Override
    ...
    private static final class NoNo implements Star
    {
        @Override
        public void prepare()
        {
