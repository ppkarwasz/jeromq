...
import org.zeromq.ZProxy.Proxy.SimpleProxy;

public class TestZProxy
{
    private final class ProxyProvider extends SimpleProxy
    {
        ...
        @Override
        public Socket create(ZContext ctx, Plug place, Object... extraArgs)
        {
            Socket socket = null;
